...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://rsous.github.io/pizzeria">View Demo</a>
    ·
    <a href="https://github.com/rsous/pizzeria/issues">Report Bug</a>
    ·
    <a href="https://github.com/rsous/pizzeria/issues">Request Feature</a>
  </p>
</p>
...
Original design taken from [freepik.com](https://www.freepik.com/free-psd/moody-restaurant-food-web-site-mock-up_6598706.htm) (which consists of a PSD and a jpeg file).
...
1. Clone the repo
   ```sh
   git clone https://github.com/rsous/pizzeria.git
   ```
...
See the [open issues](https://github.com/rsous/pizzeria/issues) for a list of proposed features (and known issues).
